...
export default class extends BaseSchema {
  ...
  public async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.string('work_quality').notNullable()
      table.string('work_quality_reason').notNullable()
      table.string('task_completion').notNullable()
      table.string('task_completion_reason').notNullable()
      table.string('over_and_abroad').notNullable()
      table.string('over_and_abroad_reason').notNullable()
      table.string('communication').notNullable()
